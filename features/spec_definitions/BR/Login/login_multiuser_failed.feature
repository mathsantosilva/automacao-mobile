...
Funcionalidade: Login no modo multiusuário - Falhas
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_email
    @br_login_multiuser_failure_email_mensagem_campo
    Esquema do Cenario: Não deve realizar login com validação de campo no E-mail
        ...
        Exemplos:
            ...
            |                                | 1     | Indique o e-mail           |
            | mobi21001@dimep.com.br         |       | Indique a senha            |

    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_email
    @br_login_multiuser_failure_email_mensagem_popup
    Esquema do Cenario: Não deve realizar login com E-mail ou senha incorretos
        ...
        Exemplos:
            | identificador               | senha | mensagem                               |
            | email_invalido@dimep.com.br | 1     | Utilizador e/ou senha estão incorretos |
            | mobi21001@dimep.com.br      | 999   | Utilizador e/ou senha estão incorretos |

    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_pis
    @br_login_multiuser_failure_pis_mensagem_campo
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_pis
    @br_login_multiuser_failure_pis_mensagem_popup
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_cpf
    @br_login_multiuser_failure_cpf_mensagem_campo
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_cpf
    @br_login_multiuser_failure_cpf_mensagem_popup
    Esquema do Cenario: Não deve realizar login utilizando CPF inválido
        Dado seleciono a opção de login "CPF"
        E informo o identificador "<identificador>"
        E informo a senha "<senha>"
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_matricula
    @br_login_multiuser_failure_matricula_mensagem_campo
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_matricula
    @br_login_multiuser_failure_matricula_mensagem_popup
    Esquema do Cenario: Não deve realizar login utilizando Matrícula inválida
        Dado seleciono a opção de login "Matrícula"
        E informo o identificador "<identificador>"
        E informo a senha "<senha>"
    ...
    @br_login_multiuser_failure_online
    @br_login_multiuser_failure_tipo_login_incorreto
    Esquema do Cenario: Não deve realizar login quando o tipo de login não corresponde ao identificador informado
        ...
        Exemplos:
            ...
            | PIS        | mobi21001@dimep.com.br | 1     | Utilizador e/ou senha estão incorretos |
            | CPF        | mobi21001@dimep.com.br | 1     | Indique um CPF válido                  |
            | Matrícula  | mobi21001@dimep.com.br | 1     | Utilizador e/ou senha estão incorretos |

    @br_login_multiuser_failure_offline
    @br_login_multiuser_failure_offline_login_sem_permissao
    Esquema do Cenario: Não deve realizar login offline quando o usuário não tem permissão para marcação offline
        ...
        Exemplos:
            | tipo_login | identificador          | senha | mensagem                                          |
            | E-mail     | mobi21001@dimep.com.br | 1     | Usuário não tem permissão para marcação offline   |
    ...
    @br_login_multiuser_failure_offline
    @br_login_multiuser_failure_offline_login_senha_incorreta
    Esquema do Cenario: Não deve realizar relogin offline com senha incorreta
        ...
        Exemplos:
            | tipo_login | identificador          | senha | mensagem                               |
            | E-mail     | mobi21002@dimep.com.br | 999   | Utilizador e/ou senha estão incorretos |
