...
Funcionalidade: Login no app mobile
    ...
    Cenario: Login utilizando email e senha
        Dado que preencho o email "mobi21002@madis.com.br" e  a senha "1" e clico no botão principal "ENTRAR" no aplicativo MD
    ...
    Cenario: Login utilizando email e senha tela de marcação
        Dado que preencho o email "mobi21003@madis.com.br" e  a senha "1" e clico no botão principal "ENTRAR" no aplicativo MD
    ...
    Cenario: Login utilizando utilizando multiuser
        Dado realizo o login com o email "mobistore@madis.com.br" e  a senha "1" master e clico em "ENTRAR" no aplicativo MD
        ...
        Quando habilito a opção "Habilitar modo de múltiplo usuário" e seleciono a empresa e filial do ambiente MD
            |Empresa|Testes Mobile - 23-02-22 - 1017    |
            |Filial |Filial de teste - 23-05-2022 - 1747|
    ...
    Cenario: Login utilizando azure ad
        Dado que clico no botão Entrar com azure AD no aplicativo MD
        Quando preencho o email "2018@testexpto.onmicrosoft.com" e senha "Dimep*25" e clico em entrar na microsoft enterprise do ambiente MD
        Então deverá direcionar para a dashboard e apresentar o nome do funcionario azure "Pessoa0022 Ad" e marcar ponto demonstrando a mensagem "PONTO MARCADO COM SUCESSO" em portugues-md