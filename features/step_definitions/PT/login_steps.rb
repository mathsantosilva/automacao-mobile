...
Então('devo conseguir realizar login com a opção NÚMERO DO FUNCIONÁRIO, utilizando a senha {string}, clicar em {string} e receber a mensagem de sucesso ao marcar ponto {string}') do |string, string2, string3, table|    
